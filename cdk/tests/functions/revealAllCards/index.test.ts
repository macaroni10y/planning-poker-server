...
import type { RevealAllCardsParams } from "../../../src/types/actionParams";
...
describe("revealAllCards", () => {
	...
	beforeEach(() => {
		...
		updateCardNumberInRoomAndUserSpy = jest.spyOn(
			planningPokerRepository,
	...
	it("should reveal all cards successfully", async () => {
		...
		expect(updateCardNumberInRoomAndUserSpy).toHaveBeenCalledWith(
			"__room_id__",
			"__client_id_1__",
			"skip",
		);
